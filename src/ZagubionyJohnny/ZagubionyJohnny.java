...
{	
	...
	public ZagubionyJohnny() 
	{
		...
		konsola.setBounds(10, 500, 780, 100);
		...
		konsola2.setBounds(10, 630, 780, 170);
	    ...
	    konsola.addKeyListener(new KeyAdapter()
	    {
	    	public void keyPressed(KeyEvent e)
	        {
	            ...
	            if (e.getKeyCode() == KeyEvent.VK_ENTER)
	            {
	            	...
	            	konsola.getDocument().putProperty("filterNewlines", Boolean.TRUE);
                ...
                if ((k == 0 && l == 0) || (k == 0 && l == 2) || (k == 0 && l == 4) || (k == 1 && l == 3))
                {
                    korytarz.setIcon(new ImageIcon("Mapy/2.png"));
                }
                
                if ((k == 1 && l == 0) || (k == 2 && l == 1) || (k == 2 && l == 2) || (k == 5 && l == 2) || (k == 5 && l == 4))
                {
