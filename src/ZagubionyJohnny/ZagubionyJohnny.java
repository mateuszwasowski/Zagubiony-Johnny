		...
		for (int j = 0; j < fieldHeight; j++)
		{
			for (int i = 0; i < fieldWidth; i++)
			{
				...
				fieldButtons[temp1][temp2].addMouseListener(new MouseAdapter()
				{
					...
					{
						// resetowanie strażników przy kliknięciu myszy
						straznikRed.setVisible(false);
						straznikBlue.setVisible(false);
						straznikGreen.setVisible(false);
						...
						//////////////////////////////////////////////////////////////////////////////////
						// sprawdzamy czy po zmianie kamery znajdujemy się w
						////////////////////////////////////////////////////////////////////////////////// pomieszczeniu
						////////////////////////////////////////////////////////////////////////////////// ze
						////////////////////////////////////////////////////////////////////////////////// straznikiem.
			...
			public void keyPressed(KeyEvent e)
			{
				...
				if (rozmowa == 0)
				{
					if (e.getKeyCode() == KeyEvent.VK_ENTER)
					{
						...
						if (randomInt == 1)
						konsola2.setText("Hacker: Johnny, " + komendy + "\nJohnny: Już jestem. Gdzie teraz?");
                                                if (randomInt == 2)
						konsola2.setText("Hacker: Johnny, " + komendy + "\nJohnny: Dobra, dotarłem. Co dalej?");
						...
						else if (a == g1) // sciana na wprost
						{
									...
									|| (k == 5 && l == 4))
							{
                                                            ...
                                                            if (randomInt == 2)
                                                            konsola2.setText("Hacker: Johnny, " + komendy + "\nJohnny: Nie przeniknę przez ścianę!");
							}
							...
							else 
							{
								...
								{
                                                                    if (randomInt == 0)
                                                                    konsola2.setText("Hacker: Johnny, " + komendy + "\nJohnny: Drzwi są zamknięte!");
                                                                    if (randomInt == 1)
                                                                    konsola2.setText("Hacker: Johnny, " + komendy + "\nJohnny: Nie mogę otworzyć tych drzwi!");
                                                                    if (randomInt == 2)
                                                                    konsola2.setText("Hacker: Johnny, " + komendy + "\nJohnny: Ktoś zamknął drzwi na klucz!");
								} 
						...
						else if (a == 6) // johnny rozmawia ze straznikiem
						{
							...
							if (buttonjohnny.getX() == r.getX() && buttonjohnny.getY() == r.getY())
							{
								if (r.finished())
								{
									konsola2.setText("Hacker: Johnny, " + komendy + "\nJohnny: Nic nie mówi. Normalnie skamieniał!");
									rozmowa = 0;
								} 
					...
					if (e.getKeyCode() == KeyEvent.VK_ENTER)
					{
						...
						if (rozmowa > 5)
						{
							if (buttonjohnny.getX() == r.getX() && buttonjohnny.getY() == r.getY())
							{
								if (r.success())
								{
									konsola2.setText("Strażnik: TAK, to jest to!!\nJohnny: Przyjacielu, mam klucz, zaprowadź mnie do\nczerwonych drzwi!");
									r.setDone();
									kluczRed = true;
								...
								{
									konsola2.setText("Strażnik: Cokolwiek powiedziałeś, to na pewno nie była ta odpowiedź na którą czekam! Przemyśl to\ni przyjdź jeszcze raz!");
								}
							}
