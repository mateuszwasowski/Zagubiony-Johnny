...
public class Straznik {
	...
	private String[] pytaniaBlue = {
			...
			"Choæ ma pancerz, to nie wojuje,choæ ma cztery nogi\n– wolno spaceruje. Co to?",
	...
	public Straznik(String s) {
		...
		List<Map.Entry<Integer, Integer>> randAccess = new ArrayList<Map.Entry<Integer, Integer>>(
				map.entrySet());
	...
	public String rozmowa(int r) {
		...
		if (r == 1) {
			...
			if (kolor == "czerwony") {
				...
				ret = "Stra¿nik: Witaj, jestem stra¿nikiem zielonego klucza!\nTylko on umo¿liwi Ci przejœcie przez zielone\ndrzwi!\n                                              ->";
			}
		}
